...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
disp('1. Ajuste de Curvas: ajustando a tabela de dados armazenada no arquivo dados.txt com polinômios de grau 1 a 5.');
disp('Os dados de r2 e var de cada função de ajuste aparecerão na tela a seguir.');
disp(' ');
...
disp('Como o polinômio de grau 3 permitiu assim a menor variancia residual, ele foi o escolhido para a nossa aproximação,');
disp('ao substituir 2,8 volumes nesta equação teremos uma boa estimativa para a função.');
fprintf('\n');
