...
disp(' ');
disp(' Chamando 1/y de Y e 1/[S] de X, teremos entao:  ');
disp(' ');
disp(' Y = (Ks/Vm)*X + 1/Vm');
disp(' ');
...
disp(' ');
disp('Invertendo a funcao dos dois lados para manter a igualdade, temos: ');
disp(' 1/y = Ks^2/Vm[S]^2 + 1/Vm');
disp(' ');
disp(' Chamando 1/y de Y e 1/[S]^2 de X, teremos entao:  ');
disp(' ');
